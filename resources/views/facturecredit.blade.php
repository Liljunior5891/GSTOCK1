    ...
    <div class="wrapper">
        ...
        <section class="invoice">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <br>
                <address>
                    <b class="list-group-item"> Nom: <span class="text-danger" >{{$vente[0]->nom}}</span> </b>
                    <b class="list-group-item">Prenom : <span class="text-danger" >{{$vente[0]->prenom}}</span> </b>
                    <b class="list-group-item">Contact : <span class="text-danger" >{{$vente[0]->contact}}</span> </b>
                </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <b class="list-group-item">Montant donné : <span class="text-danger" >{{$vente[0]->donne}} fcfa</span> </b>
                    <b class="list-group-item">Montant restant : <span class="text-danger" >{{$vente[0]->restant}} fcfa</span> </b>
                </address>
            </div>

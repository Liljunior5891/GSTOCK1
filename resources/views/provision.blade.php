            ...
            <div class="row">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <a class="btn btn-default mb-xs mt-xs mr-xs btn btn-default" href="{{route('newcommande')}}"><i class="fa fa-plus"></i>Ajouter une commande directe</a>
                        <a class="btn btn-default mb-xs mt-xs mr-xs btn btn-primary" href="{{route('newcommande2')}}"><i class="fa fa-plus"></i>Ajouter une commande indirecte</a>
